...
/**
 * Queues call-origins view, ported from bluerocktelclients'
 * App\Filament\Resources\ExpertStatistics\MyQueues\Pages\MyQueuesOrigins.
 */
class MyQueuesOrigins extends Component
{
    ...
    public function loadData(): void
    {
        ...
        try {
            ...
            $raw = app(ExpertStatisticsService::class)->getOrigin('queue', $params, $this->isTop10);
    ...
    {
        return view('expert-statistics::livewire.reports.my-queues.origins');
    }
