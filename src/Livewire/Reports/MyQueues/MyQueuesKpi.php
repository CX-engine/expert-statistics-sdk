...
/**
 * Queues KPI view, ported from bluerocktelclients'
 * App\Filament\Resources\ExpertStatistics\MyQueues\Pages\MyQueuesKpi.
 */
class MyQueuesKpi extends Component
{
    ...
    public function loadData(): void
    {
        ...
        try {
            ...
            $raw = app(ExpertStatisticsService::class)->getKpi('queue', $this->granularity, $params);
    ...
    {
        return view('expert-statistics::livewire.reports.my-queues.kpi');
    }
