...
class MyNumbersReport extends Component
{
    ...
    /**
     * Points at DidReportExportController's route, wired by a later phase
     ...
     * CallAnalysis::getExportUrl(). There is no bluerocktelclients reference
     * for this export - built directly from ExpertStatisticsService::
     * streamDidReportFile(), mirroring the sibling reports' getExportUrl().
     */
    public function getExportUrl(): string
    {
        if (! $this->dn || ! $this->startDate || ! $this->endDate || ! Route::has('expert-stats.my-numbers.export')) {
            return '#';
        }
        ...
        return route('expert-stats.my-numbers.export', $params);
    }
