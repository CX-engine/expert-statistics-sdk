<x-expert-statistics::cluster-layout :title="__('expert-statistics::pbx.expert_statistics.my_queues_origins_title')">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <button wire:click="toggleHideEmpty" type="button"
                ...
                {{ __('expert-statistics::pbx.expert_statistics.origins_show_empty_queues') }}
            </button>
        </div>
    </div>
