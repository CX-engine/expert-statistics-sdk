<x-expert-statistics::cluster-layout :title="__('expert-statistics::pbx.expert_statistics.my_users_kpi_title')">
    ...
    @if (! $dn)
        <div wire:loading.remove wire:target="{{ $loadingTargets }}"
            ...
            <h3 class="text-base font-semibold text-gray-600 dark:text-gray-400 mb-2">
                {{ __('expert-statistics::pbx.expert_statistics.my_users_kpi_title') }}
            </h3>
